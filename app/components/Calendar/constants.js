...
export const FETCH_TIMERANGE = 'BookingCalendar/FETCH_TIMERANGE';
export const FETCH_TIMERANGE_SUCCESS =
  'BookingCalendar/FETCH_TIMERANGE_SUCCESS';

export const ARTIST_QUERY = `
query($id: ID, $showAvailabilityDetail: Boolean, $startDate: Date!, $endDate: Date!){
  artist(id: $id) {
    calendar {
      id
      bookingAvailability(gte: $startDate, lte: $endDate, showAvailabilityDetail: $showAvailabilityDetail) {
        amtSlotsFilled
        amtSlotsOpen
        confirmedSlots {
          venue {
